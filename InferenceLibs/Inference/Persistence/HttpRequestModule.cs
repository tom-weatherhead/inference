...
namespace Inference.Persistence
{
    public class HttpRequestModule : IHttpModule
    {
        public String ModuleName
        {
            get
            {
                return "NHibernateHelper_ThreadAndHttpContext";
            }
        }
        ...
        private void Application_BeginRequest(object source, EventArgs e)
        {
            ...
            NHibernateHelper_ThreadAndHttpContext.GetSession();   // TW 2011/07/23 : Commented out.
        }
        ...
        private void Application_Error(object sender, EventArgs e)
        {
            ...
            NHibernateHelper_ThreadAndHttpContext.RollbackTransaction();    // This also closes the Session.
        }
