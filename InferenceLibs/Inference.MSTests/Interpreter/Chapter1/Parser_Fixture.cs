...
namespace Inference.MSTests.Interpreter.Chapter1
{
    [TestClass]
    public class Parser_Fixture
    {
        ...
        //[SetUp]   // NUnit
        [TestInitialize]    // See http://stackoverflow.com/questions/92869/nunit-vs-visual-studio-2008s-test-projects-for-unit-testing
        public void SetUp()
        {
            globalInfo.Clear();
