...
namespace NHibernateHelperLib.Persistence
{
    ...
    {
        public static IContextCache<T> Create<T>(string key) where T : class
        {
#if InferenceWeb
	...
	public static class NHibernateHelper
	{
        ...
        private static readonly IContextCache<ISession> _sessionCache = ContextCacheFactory.Create<ISession>(_httpContextSessionKey);
        private static readonly IContextCache<ITransaction> _transactionCache = ContextCacheFactory.Create<ITransaction>(_httpContextTransactionKey);
        ...
        public static void Initialize(List<Assembly> assemblyList) // To be called from a static constructor in the client assembly.
		{

            if (_configuration != null && _sessionFactory != null)
            {
                return;
            }
            ...
            new SchemaExport(cfg).Execute(script, export, justDrop);
                ...
                assemblyList.ForEach(assembly => _configuration.AddAssembly(assembly));
        ...
        private static SchemaExport GetSchemaExportObject()
        {
            return new SchemaExport(_configuration);
        }

        private static SchemaUpdate GetSchemaUpdateObject()
        {
        ...
        {
            var ddlExport = GetSchemaExportObject();
            ...
            // ThAW 2012/11/02 : What should the "script" paramater value be in the Create(), Drop(), and Execute() calls?
        ...
        public static void UpdateDatabase()
        {
            ...
            var ddlUpdate = GetSchemaUpdateObject();
